...
const App: React.FC = () => {
  ...
  return (
    <div className="flex h-screen bg-[#0d0d0d] text-slate-200 overflow-hidden font-['Inter'] relative">
      ...
      <main className="flex-1 overflow-hidden relative flex flex-col">
        ...
        {currentView === ViewType.VISION && (
           <div className="flex flex-col h-full items-center justify-center text-center p-6">
             ...
             <h2 className="text-3xl font-bold mb-2">Vision Creator</h2>
             <p className="text-slate-500 max-w-xs">Fitur pembuatan gambar AI sedang dalam tahap pengembangan. Nantikan pembaruan selanjutnya!</p>
             <div className="mt-8 px-4 py-2 rounded-full border border-indigo-500/30 text-indigo-400 text-xs font-bold uppercase tracking-widest">Coming Soon</div>
           </div>
        )}
             ...
             <div className="flex-1 overflow-y-auto">
                <div className="max-w-2xl mx-auto p-6 md:p-12 w-full">
                  ...
                  <div className="space-y-4">
                    {[
                      { v: "V3.0 (Now)", d: "10 Apr", current: true },
                      { v: "V2.9", d: "31 Mar" },
                      { v: "V2.7", d: "15 Mar" },
                      { v: "V2.6", d: "12 Mar" },
                      { v: "V2.4", d: "5 Mar" },
             ...
             <div className="flex-1 overflow-y-auto">
                <div className="max-w-2xl mx-auto p-6 md:p-12 w-full">
                  ...
                  <div className="space-y-3">
                    {[
                      { t: "Disabling Call (Quota)", d: "10 Apr", current: true },
                      { t: "Fixing Call", d: "31 Mar" },
      ...
      {callStatus && (
        <div className="fixed top-20 left-1/2 -translate-x-1/2 z-[100] bg-red-500/90 text-white px-6 py-3 rounded-2xl font-bold shadow-2xl animate-in fade-in zoom-in duration-300">
          {callStatus}
        </div>
      )}
    </div>
