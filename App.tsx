...
const App: React.FC = () => {
  ...
  const handleSendMessage = async (text: string, attachment?: ChatAttachment) => {
    ...
    try {
      const stream = await chatWithGeminiStream(text, attachment, activeSession?.messages || [], mode, user?.religion);
             ...
             <div className="flex-1 overflow-y-auto">
                <div className="max-w-2xl mx-auto p-6 md:p-12 w-full">
                  ...
                  <div className="space-y-4">
                    {[
                      { v: "V2.7 (Now)", d: "15 Mar", current: true },
                      { v: "V2.6", d: "12 Mar" },
                      { v: "V2.4", d: "5 Mar" },
                      { v: "V2.0", d: "29 Feb" },
                      { v: "V1.9", d: "20 Feb" },
             ...
             <div className="flex-1 overflow-y-auto">
                <div className="max-w-2xl mx-auto p-6 md:p-12 w-full">
                  ...
                  <div className="space-y-3">
                    {[
                      { t: "Fixing Setting Tab (Now)", d: "15 Mar", current: true },
