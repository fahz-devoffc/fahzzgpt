    ...
    <div className="flex flex-col h-full bg-[#212121]">
      <div className="h-14 flex items-center justify-between px-4 border-b border-white/5 bg-[#212121]">
        ...
        <div className="relative">
          ...
          <span className="absolute -top-1 -right-1 text-[7px] font-bold bg-red-500 text-white px-1 rounded-full uppercase">Soon</span>
        </div>
      </div>
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto custom-scrollbar p-4 space-y-8 max-w-3xl mx-auto w-full">
        {session.messages.length === 0 && (
           <div className="h-full flex flex-col items-center justify-center text-center py-20">
              <div className="w-16 h-16 rounded-2xl vikey-gradient flex items-center justify-center text-3xl font-black italic shadow-2xl mb-6 animate-rotate-3d">F</div>
